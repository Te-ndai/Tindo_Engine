...
grep -qF "\"contract\": \"command_registry\"" runtime/schema/command_registry.json || fail "command_registry missing contract tag"
grep -qF "\"commands\"" runtime/schema/command_registry.json || fail "command_registry missing commands"
