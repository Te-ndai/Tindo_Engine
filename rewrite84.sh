...
# Anchor to repo root as "directory containing this script"
...
[ -d "$REPO_ROOT/test" ] || die "missing test dir at: $REPO_ROOT/test"
[ -d "$REPO_ROOT/runtime" ] || die "missing runtime dir at: $REPO_ROOT/runtime"

OUT="$REPO_ROOT/test/84_test_restore_replay.sh"
...
chmod +x "$OUT"
ok "rewrote: test/84_test_restore_replay.sh"
echo "Run:"
